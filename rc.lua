...
beautiful.init("/home/isaak/.config/awesome/themes/theme.lua")
...
-- Register widget
vicious.register(netwidget, vicious.widgets.net, 'down:<span color="#CC9393">${eth0 down_kb}kb</span> up:<span color="#7F9F7F">${eth0 up_kb}kb</span>', 3)
-- cpu usage widget
